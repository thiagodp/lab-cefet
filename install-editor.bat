...
code --install-extension ritwickdey.liveserver && code --install-extension devsense.phptools-vscode && code --install-extension rangav.vscode-thunder-client && code --install-extension qwtel.sqlite-viewer && code --install-extension bmewburn.vscode-intelephense-client
